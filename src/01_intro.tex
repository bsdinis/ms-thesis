...
very similar fashion to others that use volatile state only
replicas. Indeed, when the persistent aspect of nodes
is explicitely considered, protocols focus on when and what data they need to
