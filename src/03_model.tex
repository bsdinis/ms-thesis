...
read quorums. Handling this peculiarity will require some protocol support in
order to avoid having situations where two non-intersecting
read quorums hold different views of the system without
knowledge of the progress made by the other part. However, in
certain parametrizations, property \textbf{I2} can be guaranteed
never to hold, and thus such extraneous protocol infrastructure
can be avoided. We classify \ac{RR} quorum systems in two
