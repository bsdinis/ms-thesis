...
set output 'crash/crash_isolated.eps'
...
plot 'crash/crash_0_crash transfer.dat' title 'Crash Transfer' with lp linestyle 1, 'crash/crash_100_crash get.dat' title 'Crash Get' with lp linestyle 3
