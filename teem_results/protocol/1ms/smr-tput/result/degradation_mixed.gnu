...
set output 'result/degradation_mixed.eps'
...
plot 'result/degradation_bft_mixed.dat' title 'BFT' with linespoint linestyle 1, 'result/degradation_crash_mixed.dat' title 'Crash' with linespoint linestyle 3, 'result/degradation_rr_mixed.dat' title 'RR' with linespoint linestyle 5
