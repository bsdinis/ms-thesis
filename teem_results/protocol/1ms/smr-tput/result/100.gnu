...
plot 'result/100_bft get.dat' title 'BFT Get' with linespoint linestyle 1, 'result/100_bft transfer.dat' title 'BFT Transfer' with linespoint linestyle 3, 'result/100_crash get.dat' title 'Crash Get' with linespoint linestyle 5, 'result/100_crash transfer.dat' title 'Crash Transfer' with linespoint linestyle 7, 'result/100_rr get.dat' title 'RR Get' with linespoint linestyle 9, 'result/100_rr transfer.dat' title 'RR Transfer' with linespoint linestyle 11
