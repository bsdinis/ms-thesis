...
set output 'result/degradation.eps'
...
plot 'result/degradation_bft.dat' title 'BFT' with linespoint linestyle 1, 'result/degradation_crash.dat' title 'Crash' with linespoint linestyle 3, 'result/degradation_rr.dat' title 'RR' with linespoint linestyle 5
