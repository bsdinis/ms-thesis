...
set output 'full/eps/full_troughput.eps'
...
set xrange [0:6500]
set yrange [0:*]
plot 'bft/dat/read_throughput.dat' title 'BQS Read' with yerrorbars linestyle 3 pointtype 6, '' notitle with lines linestyle 2, 'bft/dat/write_throughput.dat' title 'BQS Write' with yerrorbars linestyle 3 pointtype 8, '' notitle with lines linestyle 2, 'r3/dat/read_throughput.dat' title 'R^3 Read' with yerrorbars linestyle 5 pointtype 6, '' notitle with lines linestyle 4, 'r3/dat/write_throughput.dat' title 'R^3 Write' with yerrorbars linestyle 5 pointtype 8, '' notitle with lines linestyle 4
